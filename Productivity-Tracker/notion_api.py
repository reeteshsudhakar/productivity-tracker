...
DATABASE_ID = "8c579d21214e4d37a2f9da9065d8cbad"
...
class NotionSync:
    ...
    def query_databases(self,integration_token="secret_UYxAfJUKmyGib18LShp0YKd92NcmYo4Xo9xOxqd5Lam"):
        ...
        if response.status_code != 200:
            raise BaseException(f'Response Status: {response.status_code}')
        else:
